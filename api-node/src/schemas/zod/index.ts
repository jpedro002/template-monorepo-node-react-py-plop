...
export type UserRelations = {
  user_cards: userCardsWithRelations[];
};

export type UserWithRelations = z.infer<typeof UserSchema> & UserRelations

export const UserWithRelationsSchema: z.ZodType<UserWithRelations> = UserSchema.merge(z.object({
  user_cards: z.lazy(() => userCardsWithRelationsSchema).array(),
}))
...
// USER CARDS RELATION SCHEMA
//------------------------------------------------------

export type userCardsRelations = {
  user: UserWithRelations;
  card: CardWithRelations;
};

export type userCardsWithRelations = z.infer<typeof userCardsSchema> & userCardsRelations

export const userCardsWithRelationsSchema: z.ZodType<userCardsWithRelations> = userCardsSchema.merge(z.object({
